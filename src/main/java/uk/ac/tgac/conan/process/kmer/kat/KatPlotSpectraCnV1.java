 ...
 */
public class KatPlotSpectraCnV1 extends AbstractConanProcess {

    public static final String EXE = "kat";
    public static final String MODE = "plot spectra-cn";

    public KatPlotSpectraCnV1() {
        this(new Args());
    }

    public KatPlotSpectraCnV1(Args args) {
    ...
    public String getName() {
        return "KAT_Plot_Spectra-CN_V1.0";
    }
    ...
    public static class Params extends AbstractProcessParams {
        ...
        public Params() {
            ...
            this.output = new ParameterBuilder()
                    .shortName("o")
                    .longName("output")
                    .description("Output file (\"kat-plot-spectra-cn.png\")")
                    .argValidator(ArgValidator.PATH)
                    .create();
        }
