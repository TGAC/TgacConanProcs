...
public class NizarDedupProcess extends AbstractAssemblyIOProcess {
    ...
    public static final String NAME = "nizar-dedup";
    public static final String TYPE = "dedup";
    ...
    public NizarDedupProcess(NizarDedupArgs args) {
        super(EXE, args, new NizarDedupParams());
    }

    @Override
    public AbstractAssemblyIOProcess create(AbstractAssemblyIOArgs args) {
        return new NizarDedupProcess((NizarDedupArgs)args);
    }
