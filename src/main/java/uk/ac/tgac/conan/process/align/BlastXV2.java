...
/**
 * Nucleotide 2 Protein BLAST search
 */
public class BlastXV2 extends AbstractConanProcess {

    private static final String NAME = "BlastX_V2";
    private static final String EXE = "blastx";

    public BlastXV2() {
        this(null);
    }

    public BlastXV2(ConanExecutorService ces) {
        this(ces, new Args());
    }

    public BlastXV2(ConanExecutorService ces, AbstractProcessArgs args) {
