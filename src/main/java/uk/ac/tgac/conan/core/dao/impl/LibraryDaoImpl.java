...
import uk.ac.tgac.conan.core.dao.LibraryDao;
import uk.ac.tgac.conan.core.dao.SeqFileDao;
...
public class LibraryDaoImpl implements LibraryDao {
	...
	public List<Library> getAllLibraries() {	
		...
		List<Library> libDetails = TgacConanHibernate.listAndCast(q);
		return libDetails;
	}
	
	@Override
	public List<Library> getLibraries(final String name, final Library.Dataset dataset) {
		Session session = this.sessionFactory.getCurrentSession();
