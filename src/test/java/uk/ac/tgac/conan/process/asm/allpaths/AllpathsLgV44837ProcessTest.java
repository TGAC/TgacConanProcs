...
public class AllpathsLgV44837ProcessTest {
    ...
    private AllpathsLgV44837Process createProcess() {
    ...
    public void testAllpathsCommand() throws InterruptedException, ProcessExecutionException, IOException, CommandExecutionException {
        ...
        AllpathsLgV44837Process allpaths = createProcess();
        allpaths.initialise();
    ...
    public void testGlobPattern() throws IOException {
        ...
        String globPattern = new AllpathsLgV44837Process().createGlobPattern(new File("/test/test1.fa"), new File("/test/test2.fa"));
